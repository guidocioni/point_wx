...
- Whenever a modification to the code needs to be implemented, isolate the function/code in a test script and perform all tests there before implementing in the main code. Remember to import the app so that the cache is properly initialized in the test script.
